    ...
    private function getDbalConnectionsNode(): ArrayNodeDefinition
    {
        ...
        $connectionNode
            ...
            ->children()
                ...
                ->booleanNode('keep_slave')
                    ->setDeprecated(
                        ...$this->getDeprecationMsg('"keep_slave" option is deprecated since doctrine-bundle 2.2. Use keep_replica option instead.')
                    )
                ->end()
        ...
        $slaveNode = $connectionNode
            ->children()
                ->arrayNode('slaves')
                    ->setDeprecated(
                        ...$this->getDeprecationMsg('"slaves" config key will be renamed to "replicas" in doctrine-bundle 3.0. "slaves" is deprecated since doctrine-bundle 2.2.')
                    )
                    ->useAttributeAsKey('name')
                    ->prototype('array');
